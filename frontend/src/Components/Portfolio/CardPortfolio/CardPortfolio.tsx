...
const CardPortfolio = ({portfolioValue, onPortfolioDelete}: Props) => {
  return (
     <div className="flex flex-col w-full p-8 space-y-4 text-center rounded-lg shadow-[0_0_20px_rgba(255,215,0,0.8)] md:w-1/3 relative bg-gold/80 border-4 border-gold/90 ">
